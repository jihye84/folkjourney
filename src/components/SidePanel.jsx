      ...
      {region && (
        ...
        >
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar p-3.5 md:p-5 space-y-3 md:space-y-3.5">
            ...
            <div className="p-2.5 md:p-3 bg-emerald-500/10 border border-emerald-500/25 rounded-xl shrink-0">
              <p className="text-xs font-semibold text-emerald-200 leading-relaxed break-keep">
                {region.description}
              </p>
            </div>
            ...
            {activeTab === 'music' ? (
              <>
                    ...
                    {region.chords.map((chord, idx) => {
                      ...
                      return (
                        <motion.button key={idx}
                          ...
                          className={`flex-1 min-w-[52px] relative rounded-xl flex flex-col items-center justify-start pt-1.5 pb-1 px-0.5 transition-all duration-300 border-2 min-h-[95px] overflow-hidden group
                          ...
                          <div className="scale-[0.58] transform origin-top">
                ...
                {/* ── Piano Keyboard ── */}
                <div className="bg-slate-950 rounded-xl border border-white/10 p-2 shadow-inner overflow-hidden shrink-0">
